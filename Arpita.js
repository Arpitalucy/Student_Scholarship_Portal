const userConfirmation = confirm("Welcome to the student scholarship quiz of Aveti, click \"Ok\" to start"
);
var userInput = prompt(
    "Please select your class choosing A to c \n \n A. Class-8th \n B. Class-9th \n C. Class-10th \n");
    ...
    );
    {
      switch (
        ...
        case "f":
          ...
          // alert("Go to the console section to see your result.");
...
let userInput2 = "Congratulation, your total score is 96/100";
